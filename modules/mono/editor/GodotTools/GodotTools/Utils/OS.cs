...
namespace GodotTools.Utils
{
    ...
    public static class OS
    {
        ...
        private static string? PathWhichWindows(string name)
        {
            ...
            string[] pathDirs =
                Environment.GetEnvironmentVariable("PATH")?.Split(PathSep) ?? Array.Empty<string>();
        ...
        {
            string[] pathDirs = Environment.GetEnvironmentVariable("PATH")?.Split(PathSep) ?? Array.Empty<string>();
            char[] invalidPathChars = Path.GetInvalidPathChars();
