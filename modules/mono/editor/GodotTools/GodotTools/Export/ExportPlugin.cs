...
namespace GodotTools.Export
{
    public partial class ExportPlugin : EditorExportPlugin
    {
        ...
        {
            GetExportPlatform().AddMessage(EditorExportPlatform.ExportMessageType.Error, "Export .NET Project", message);
        }
        ...
        public override void _ExportFile(string path, string type, string[] features)
        {
            ...
            if (!ProjectContainsDotNet())
            {
                AddErrorMessage($"This project contains C# files but no solution file was found at the following path: {GodotSharpDirs.ProjectSlnPath}\n" +
